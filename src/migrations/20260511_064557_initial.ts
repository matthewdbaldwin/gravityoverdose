...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "projects_blocks_image_full" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "projects_blocks_image_full" ADD CONSTRAINT "projects_blocks_image_full_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "projects_blocks_image_full" ADD CONSTRAINT "projects_blocks_image_full_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "projects_blocks_image_full_order_idx" ON "projects_blocks_image_full" USING btree ("_order");
  CREATE INDEX "projects_blocks_image_full_parent_id_idx" ON "projects_blocks_image_full" USING btree ("_parent_id");
  CREATE INDEX "projects_blocks_image_full_path_idx" ON "projects_blocks_image_full" USING btree ("_path");
  CREATE INDEX "projects_blocks_image_full_image_idx" ON "projects_blocks_image_full" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "projects_blocks_image_full" CASCADE;
